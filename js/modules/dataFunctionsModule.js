...
module.exports.stripUnits = function(data) {
  return +data.match(stripUnitRegex);
}

// filter units in columns defined in arrOfColumnNames
module.exports.stripUnitsForColumns = function(data, arrOfColumnNames) {
...
module.exports.trimWhitespace = function(data, arrOfColumnNames) {
  arrOfColumnNames.forEach(function(name) {
    if (data[name] && notEmpty(data[name])) {
...
// module.exports.replaceSpaces = function

// returns the max within the columnName of data
module.exports.getMax = function(data, columnName) {
...
module.exports.getMin = function(data, columnName) {
  var arr = [];
...
module.exports.getSum = function(data, columnName) {
...
module.exports.getMean = function(data, columnName) {
...
module.exports.getCount = function(data, columnName) {
  var arr = [];
...
module.exports.join = function(lookupTable, mainTable, lookupKey, mainKey, select) {
